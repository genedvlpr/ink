...
public class ListCommentsViewModel {
    ...
    public ListCommentsViewModel(String user_id, String first_name, String last_name, String img_profile, String comment, String date, String time) {
